...
public:
	...
	bool SpeakFindResponse( AI_Response &response, AIConcept_t conc, const char *modifiers = NULL );
	bool SpeakDispatchResponse( AIConcept_t conc, AI_Response &response, IRecipientFilter *filter = NULL );
...
public:
	...
	// These two methods allow looking up a response and dispatching it to be two different steps
	bool			SpeakFindResponse( AI_Response& response, AIConcept_t conc, const char *modifiers = NULL );
	bool 			SpeakDispatchResponse( AIConcept_t conc, AI_Response& response );
...
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline bool CAI_ExpresserHost<BASE_NPC>::SpeakFindResponse( AI_Response& response, AIConcept_t conc, const char *modifiers /*= NULL*/ )
{
	return this->GetExpresser()->SpeakFindResponse( response, conc, modifiers );
}

//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
template <class BASE_NPC>
inline bool CAI_ExpresserHost<BASE_NPC>::SpeakDispatchResponse( AIConcept_t conc, AI_Response& response )
{
	if ( this->GetExpresser()->SpeakDispatchResponse( conc, response ) )
	{
